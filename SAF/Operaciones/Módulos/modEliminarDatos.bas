...
Public Sub EliminarDatos()
    ...
    resp = MsgBox( _
        ...
        "   " & Chr(149) & "  Consultas y conexiones Power Query" & vbCrLf & _
...
FIN:
    ...
    If Err.Number <> 0 Then
        MsgBox "Error durante la limpieza:" & vbCrLf & Err.Description, vbCritical, "Error"
    End If
End Sub
...
Private Sub EliminarConsultasYConexiones()
...
'  Vacía: Universo, TamañoMuestra, PeriodoActual.
'  Conserva: Z, p, E, Mes, Año, TipoInforme.
'  Borra (Clear): grilla Muestra1.
' ============================================================
Private Sub LimpiarHojaMuestra()
    LimpiarCelda "Universo"
    LimpiarCelda "Tama" & Chr(241) & "oMuestra"
    LimpiarCelda "PeriodoActual"
    LimpiarGrilla "Muestra1", 5
End Sub
...
Private Sub LimpiarGrilla(ByVal nmNombre As String, ByVal nCols As Long)
    ...
    On Error Resume Next: rng.UnMerge: On Error GoTo 0
    rng.Clear
End Sub
