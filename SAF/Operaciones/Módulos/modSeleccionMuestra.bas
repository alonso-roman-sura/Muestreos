...
' ============================================================
'  ENTRADA DEL BOTÓN "Seleccionar Muestra"
' ============================================================
Public Sub SeleccionMuestra()
    Dim resp As VbMsgBoxResult
    resp = MsgBox("¿Est" & Chr(225) & " seguro de que desea generar una nueva muestra?", _
    ...
    GenerarMuestra "Muestra1", "Tama" & Chr(241) & "oMuestra", "Universo"

    MsgBox "Muestra generada correctamente.", vbInformation
...
Private Sub GenerarMuestra(ByVal nombreInicio As String, _
    ...
    If tamano <= 0 Or universo <= 0 Then
        MsgBox "Los valores de '" & nombreTamano & "' y '" & nombreUniverso & "' deben ser > 0." & vbCrLf & _
               "Verifique que los datos est" & Chr(233) & "n importados y el per" & Chr(237) & "odo sea correcto.", _
               vbExclamation
        Exit Sub
    End If
...
Private Sub WriteGrid(ws As Worksheet, startCell As Range, _
    ...
    For i = LBound(v) To UBound(v)
        ...
        For b = xlEdgeLeft To xlEdgeRight
            With cel.Borders(b)
                .LineStyle = xlDot
                .Weight = xlThin
